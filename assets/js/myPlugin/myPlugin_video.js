(function ($) {
    ...
    $.fn.dssettings = function (options) {
        ...
        if (element_type == 3 || element_type == '3') {
            ...
            //  window_dom += '<label><input type="radio" name="dsbullettype" value="a" '+bullet_a+' class="paragraph_check"><i class="bull">a</i></label>';
            //  window_dom += '<label><input type="radio" name="dsbullettype" value="A" '+bullet_A+' class="paragraph_check"><i class="bull">A</i></label>';
            // window_dom += '<label><input type="radio" name="dsbullettype" value="i" '+bullet_i+' class="paragraph_check"><i class="bull">i</i></label>';
            //window_dom += '<label><input type="radio" name="dsbullettype" value="I" '+bullet_I+' class="paragraph_check"><i class="bull">I</i></label>';
...
//            $('[data-step="' + current_step + '"]').find('.my_table').removeClass('table-responsive');
    ...
    $.fn.dsfontpick = function (options) {
        ...
        window_dom += '</select></span><div style="display:none;"><hr class="clear">' +
...
//            $('[data-step="' + current_step + '"]').find('.my_table').removeClass('table-responsive');
    ...
    $.loadScript(SITE_URL + 'js/myPlugin/jquery.fontselect_video.js', function () {
    ...
    if (!document.getElementById(cssId))
    {
        ...
        link.rel = 'stylesheet';
        link.type = 'text/css';
        link.href = SITE_URL + 'js/myPlugin/fontselect.css';
        link.media = 'all';
    ...
    $.loadScript(SITE_URL + 'js/myPlugin/colorpicker.js', function () {
        //Stuff to do after someScript has loaded
    ...
    if (!document.getElementById(cssId))
    {
        ...
        link.rel = 'stylesheet';
        link.type = 'text/css';
        link.href = SITE_URL + 'js/myPlugin/colorpicker.css';
        link.media = 'all';
        head.appendChild(link);
    }
//-----------------------------------------------------------------------------------
