(function ( $ ) {
    ...
    $.fn.dssettings = function( options ) {
        ...
        if(dsbullettype=='1')bullet_1 = CHECKED;
        if(dsbullettype=='A')bullet_A = CHECKED;
        if(dsbullettype=='a')bullet_a = CHECKED;
        if(dsbullettype=='i')bullet_i = CHECKED;
        if(dsbullettype=='I')bullet_I = CHECKED;
        if(dsbullettype=='disc')bullet_disc = CHECKED;
        if(dsbullettype=='circle')bullet_circle = CHECKED;
        if(dsbullettype=='square')bullet_square = CHECKED;
        ...
        if(element_type==3 || element_type=='3'){
           // window_dom += 'Order <input type="text" name="dsorder" class="dsorder" maxlength="4" value="'+dsorder+'"><br>';
            window_dom += '<form onsubmit="return false;">';
            window_dom += '<label><input type="radio" name="dsbullettype" value="1" '+bullet_1+' class="paragraph_check">1</label>';
            window_dom += '<label><input type="radio" name="dsbullettype" value="a" '+bullet_a+' class="paragraph_check">a</label>';
            window_dom += '<label><input type="radio" name="dsbullettype" value="A" '+bullet_A+' class="paragraph_check">A</label>';
            window_dom += '<label><input type="radio" name="dsbullettype" value="i" '+bullet_i+' class="paragraph_check">i</label>';
            window_dom += '<label><input type="radio" name="dsbullettype" value="I" '+bullet_I+' class="paragraph_check">I</label>';
            window_dom += '<label><input type="radio" name="dsbullettype" value="disc" '+bullet_disc+' class="paragraph_check"><i class="fa fa-circle"></i></label>';
            window_dom += '<label><input type="radio" name="dsbullettype" value="circle" '+bullet_circle+' class="paragraph_check"><i class="fa fa-circle-o"></i></label>';
            window_dom += '<label><input type="radio" name="dsbullettype" value="square" '+bullet_square+' class="paragraph_check"><i class="fa fa-square"></i></label>';
            window_dom += '</form>';
        }
        window_dom += 'Readonly? <input type="checkbox" name="dsusereditable" class="ds-user-editable flat" value="1" '+check_dsusereditable+'> &nbsp; '+
    ...
    $.fn.dsfontpick = function( options ) {
        ...
        '</span><span class="pull-right"> <span><img src="images/aa.jpg"></span> <input type="number" name="dstextheight" class="ds-text-height" maxlength="3" value="'+dstextheight+'"><br>'+
        ' <span><img src="images/av.jpg"></span><input type="number" name="dstextwidth" class="ds-text-width" maxlength="3" value="'+dstextwidth+'">'+
        '</span></div><hr>'+
