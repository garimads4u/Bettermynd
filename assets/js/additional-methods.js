(function (factory) {
    ...
    $.validator.addMethod("fburl", function (value, element) {
        return this.optional(element) || /(?:https?:\/\/)?(?:www\.)?facebook\.com\/.(?:(?:\w)*#!\/)?(?:pages\/)?(?:[\w\-]*\/)*([\w\-\.]*)/.test(value);
    }, "Please enter valid facebook url.");
    $.validator.addMethod("twitterurl", function (value, element) {
        return this.optional(element) || /(?:https?:\/\/)?(?:www\.)?twitter\.com\/.(?:(?:\w)*#!\/)?(?:pages\/)?(?:[\w\-]*\/)*([\w\-\.]*)/.test(value);
