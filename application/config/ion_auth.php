 ...
 */
$config['tables']['users'] = 'bm_users';
$config['tables']['groups'] = 'bm_groups';
$config['tables']['users_groups'] = 'bm_users_groups';
$config['tables']['login_attempts'] = 'bm_login_attempts';
 ...
 */
$config['site_title'] = "BetterMynd";       // Site Title, example.com
$config['admin_email'] = "support@bettermynd.com"; // Admin Email, admin@example.com
...
$config['forgot_password_expiration'] = 36000;                   // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
$config['contact_us_email'] = "info@bettermynd.com"; // Contact us Email, admin@example.com
/*
  | -------------------------------------------------------------------------
  | Cookie options.
  | -------------------------------------------------------------------------
...
/*
  | -------------------------------------------------------------------------
  | User status inactive Complete Email Template
  | -------------------------------------------------------------------------
  | Default: user_status.tpl.php
 */
$config['user_status_change'] = 'user_deactive.tpl.php';

/*
  | -------------------------------------------------------------------------
  | User status active Complete Email Template
  | -------------------------------------------------------------------------
  | Default: user_status.tpl.php
 */
$config['user_status_active'] = 'user_active.tpl.php';
...
/*
  ...
  | Default: user_status.tpl.php
 */
$config['user_change_password'] = 'change_password.tpl.php';
/*
  | -------------------------------------------------------------------------
  | Salt options
  | -------------------------------------------------------------------------
...
$config['message_start_delimiter'] = '<p class="alert alert-success text-left">';  // Message start delimiter
$config['message_end_delimiter'] = '</p>';  // Message end delimiter
$config['error_start_delimiter'] = '<p class="alert alert-danger text-left">';  // Error message start delimiter
