        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li class="<?php echo (isset($sidebar_data['is_active']) && $sidebar_data['is_active'] == "bettermynd_note" ? 'current-page' : ''); ?>"><a href="<?php echo SADMIN_URL; ?>bettermynd_note" ><i class="fa fa-pencil-square-o"></i> <span>Bettermynd Note</span></a></li>
