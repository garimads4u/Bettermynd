<div class="col-sm-6 col-xs-12 col-sm-offset-3">
    ...
    <div class="x_panel">
        <div class="x_content">
            <?php
            $attributes = array('id' => 'user_change_password', 'class' => 'myprofile form-horizontal', 'autocomplete'=>"off");
            echo form_open(THIRD_PARTY_URL . "user_change_password/", $attributes);
            ?>
            <div class="row">
                <div class="col-sm-12">
