...
//                        });
            ...
            <form action="<?php echo THIRD_PARTY_URL; ?>saveavailabality" method="post" id="avail_form">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" id="avail_submit">Save</button>
                </div>
            </form>
        </div>
    </div>
...
<div id="updateModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo THIRD_PARTY_URL; ?>updateavailabality" method="post" id="availablity_frm">
                <div id="target_body">
...
?>
    ...
    minDate:new Date(<?php echo date('Y'); ?>, <?php echo date('m') - 1; ?>, <?php echo date('d') + 1; ?>), /* format: 'MM/DD/YYYY' */			stepping:15, sideBySide: true, useCurrent: false, showClose: true, toolbarPlacement: 'bottom', tooltips: {close: 'Close'}
    /* format: 'MM/DD/YYYY' */
