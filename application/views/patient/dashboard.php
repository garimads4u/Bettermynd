<section class="new-dashboard">
    <!--<h2>Welcome To BetterMynd</h2>-->
    ...
    <div class="row flex-div">
        ...
        <div class="col-sm-7">
            <div class="panel panel-default">
                <div class="panel-heading"><h4><?php echo isset($bettermynd_note_data->note_title) && !empty($bettermynd_note_data->note_title) ? $bettermynd_note_data->note_title : ''; ?></h4> <a href="javascript:void(0)" title="Edit"><i class="fa fa-pencil"></i></a></div>
                <div class="panel-body">
                    <p><?php echo isset($bettermynd_note_data->notes_detail) && !empty($bettermynd_note_data->notes_detail) ? nl2br($bettermynd_note_data->notes_detail) : ''; ?></p>

                    <div class="button-group">
                        <ul class="list-inline">
                            <li><a href="http://screening.mentalhealthamerica.net/screening-tools" class="btn" target="_blank">Mental Health Screening Tools</a></li>
                            <!--<li><a href="https://goo.gl/forms/cPi6XfD5IjGBehW83" class="btn" target="_blank">Try BetterMynd for Free</a></li>-->
                            <li><a href="http://www.ulifeline.org" class="btn" target="_blank">Additional Resources</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="panel panel-default">
                <div class="panel-heading"><h4>On-Campus Resources</h4>  <a href="javascript:void(0)" title="Edit"><i class="fa fa-pencil"></i></a></div>
                <div class="panel-body pdng0">
                    <div class="gallery">
                        <?php if (isset($welcome_data->logo_cover) && !empty($welcome_data->logo_cover)) { ?>
                            <img src="<?php echo IMAGE_VIEW_URL; ?>?image=/<?= $welcome_data->logo_cover; ?>&width=500&height=150&cropratio=4:1&doc_root=<?php echo urlencode(FILE_UPLOAD_PATH . 'welcome_note_image/'); ?>" class="img-responsive" />
                        <?php } else { ?>
                            <img src="<?php echo ASSETS_URL; ?>images/campus.jpg" class="img-responsive" alt="campus image" title="Bettermynd Campus"/>
                        <?php } ?>
                    </div>
                    <div class="campus-detail">
                        <div class="gallery">
                            <?php if (isset($welcome_data->logo_image) && !empty($welcome_data->logo_image)) { ?>
                                <img src="<?php echo IMAGE_VIEW_URL; ?>?image=/<?= $welcome_data->logo_image; ?>&width=150&height=150&cropratio=1:1&doc_root=<?php echo urlencode(FILE_UPLOAD_PATH . 'welcome_note_image/'); ?>" class="img-responsive" />
                            <?php } else { ?>
                                <img src="<?php echo IMAGE_VIEW_URL; ?>?image=/no_images.png&width=150&height=150&cropratio=1:1&doc_root=<?php echo urlencode(FILE_UPLOAD_PATH); ?>" class="img-responsive" />
                            <?php } ?>
                        </div>
                        <h5><?php echo $campus_details->college_name ?></h5>
                        <p><?php echo isset($welcome_data->notes_detail) && !empty($welcome_data->notes_detail) ? nl2br($welcome_data->notes_detail) : ''; ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php if (isset($welcome_note_image) && $welcome_note_image) { ?>
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="bettermynd-gallery">
                    <div class="row">
                        <?php
                        foreach ($welcome_note_image as $key => $value) {
                            if ($key != 0 && $key % 4 == 0) {
                                ?>
                            </div><div class="row">
                            <?php }
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <img src="<?php echo IMAGE_VIEW_URL; ?>?image=/<?= $value->image; ?>&width=200&height=200&cropratio=1:1&doc_root=<?php echo urlencode(FILE_UPLOAD_PATH . 'welcome_note_image/'); ?>" class="img-responsive" alt="campus image" />
                            </div>
                        <?php } ?>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 recentactivity latestmsg">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="text-left bdr-bottom">
