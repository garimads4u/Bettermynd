   ...
   if(isset($message) && strlen($message)>0 ) { 
    ...
    <div class="x_panel">
        <div class="x_content">
            <div class="row">
            <?php
                $attributes = array('id' => 'add_user', 'class' => 'form-horizontal','autocomplete'=>"off");
                echo form_open(COMPANY_URL . "create_user", $attributes);
                ?>
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    $options =$groups;
                                    $selected = '';
                                    $attr = 'class="groups_dropdown form-control" multiple="multiple"';
                        ...
                        <div class="col-sm-12">
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    <li role="presentation" class="active"> <a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Company Paid
                                            <input type="checkbox" class="flat" checked name='paidby[]' value='company'>
                                        </a> </li>
                                    <li role="presentation" > <a href=" #tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false"> User Paid
                                            <input type="checkbox" class="flat" name='paidby[]' value='user'>
                                        </a> </li>
                                    <li class="total-monthly-hidden"><a href="javascript:void(0)">TOTAL: 
                                            <?php if (isset($membership_packages) && !empty($membership_packages) && count($membership_packages) > 0) {
                                                ?>
                                                <span id='coupon' ><?php echo CURRENCY_SYMBOL; ?><?php echo $membership_packages[0]['package_amount']. ' ' .$membership_packages[0]['package_mode'] ; if(isset($tax) && $tax>0){?>  +<small><?php echo $this->basic_model->get_tax();?>% Tax of $<?php echo $membership_packages[0]['package_amount'];?></small><?php } ?></span>
                                                <input type="hidden" name="final_amount" id="final_amount" value="<?php echo $membership_packages[0]['package_amount']; ?>" />
                                            <?php }
                                            ?>
                                        </a> </li>
                                    <li class="ques"><a tabindex="0" class="question_pop" data-toggle="popover" data-placement="bottom" data-html="true" data-trigger="focus"><img src="<?php echo IMAGES_URL; ?>question_icon.png"></a><div id="question_popover" class="hide">Company Paid option will automatically charge the Primary Account holder’s payment source for the additional user account. <br>
                                <br>
                                User Paid option will create the users account, but lock its functions until they add their personal billing details and pay for the membership.</div></li>
                                </ul>
                                        ...
                                        <div>
                                            <div>
                                                <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                                                    ...
                                                    <div class="">
                                                    <div class="col-sm-7">
                                                     <a class="panel-heading" role="tab" id="company-collapse" data-toggle="collapse" data-parent="#accordion" href="#" aria-expanded="false" aria-controls="company_collapse">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    <?php if (isset($membership_packages) && !empty($membership_packages) && count($membership_packages) > 0) {
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <?php echo lang('membership_package_label', 'email'); ?><br/>
                                                                                <?php
                                                                                $i = 1;
                                                                                foreach ($membership_packages as $package) {
                                                                                    ...
                                                                                    ?>
                                                                                    <div class="member_pack_input"><input data-mtype="radio" <?php echo $state; ?> type="radio" data-price="<?php echo $package['package_amount']; ?>" data-type="<?php echo ucwords(strtolower($package['package_mode'])); ?>" name="membership_plan[]" id="membership_plan<?php echo $package['package_id']; ?>" class="package_radio flat" value="<?php echo $package['package_id']; ?>" />
                                                                            ...
                                                                            <div class="form-group" id="issubscription">
                                                                                <input type="checkbox" name="is_subscription" data-mtype="check"  id="is_subscription" value="1" class="flat" />&nbsp;<label class="no-label-formatting" for="is_subscription"> I agree to pay the auto renew for monthly subscription.</label>
                                                                            </div>
                                                                        </div>
                                                                    <?php }
                                                                    ?>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <?php echo form_input($card_number); ?> <i class="cccard" aria-hidden="true"></i>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-3">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="form-group">
                                                                            <?php echo form_input($cvv_code); ?>  <i class="cvv_icon" aria-hidden="true" title='3 digit no. printed on back of your card.'></i>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                            ...
                                            <div>
                                                <div class="accordion" id="accordion1" role="tablist" aria-multiselectable="true">
                                                    ...
                                                    <div class="panel"> <a class="panel-heading collapsed" role="tab" id="create_payment_info" data-toggle="collapse" data-parent="#accordion1" href="#create-payment-info" aria-expanded="false" aria-controls="create-payment-info">
                                                        ...
                                                        <div id="create-payment-info" class="panel-collapse collapse" role="tabpanel" aria-labelledby="create_payment_info">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="register-buttons">
                        <?php echo form_submit('submit', 'Add User', array("class" => "btn btn-primary")); ?>
		  ...
		  $("#coupon_btn").click(function(e) {
			...
			var returnjson=JSON.parse(data);
					...
					$("#custom_error").text("Coupon Successfully Applied");
						$("#coupon_code").css("background-color","#ebebeb !important");
		...
		$("#btnclear").click(function(e) {
				...
				if(all_radios.length>0){
					...
					if(all_classes.indexOf("checked")>0){
						...
						document.getElementById("coupon_code").removeAttribute("readonly");
						document.getElementById("coupon_code").style.backgroundColor="#FFF";
						if($("#btnclear").hasClass("hide")){
						}
						else{
