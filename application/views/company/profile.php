...
$attributes = array('id' => 'profile_frm', 'class' => 'myprofile form-horizontal','enctype'=>'multipart/form-data');
 echo form_open(COMPANY_URL."update_profile",$attributes);?>
     ...
     <?php echo form_input($action); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                   <?php echo lang('edit_user_zipcode_label', 'zipcode');?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <?php echo lang('edit_user_company_logo_label', 'company_logo2');?>
                            <div class="input-group">
                ...
                <div class="register-buttons">
                    <?php echo form_submit('submit', $btn_label ,array("class"=>"btn btn-primary"));?>
                    <a href='<?php echo COMPANY_URL."dashboard"?>' class='btn btn-default'> Cancel </a>
