				...
				<table class="table">
				  <thead>
					<tr >
					  ...
					  <th style="padding:14px 10px;text-align:right;">Subtotal</th>
					</tr>
				  </thead>
				  <tbody>
			...
			<div class="table-responsive">
				  <table class="table">
					<tbody>
					  ...
					  <tr>
						<th style="width:50%;text-align:right !important; vertical-align:middle">Tax</th>
						<td align='right'><?php echo  isset($invoice_data['tax']) && $invoice_data['tax']!="" ? CURRENCY_SYMBOL.number_format($invoice_data['tax'],2) : CURRENCY_SYMBOL.'0.00'; ?></td>
					  </tr>
					 
					  <tr>
						<th style="width:50%;text-align:right !important; vertical-align:middle">Total:</th>
						<td align='right'><?php echo CURRENCY_SYMBOL. number_format($invoice_data['total_amount_after_discount'],2); ?></td>
					  </tr>
					</tbody>
				  </table>
