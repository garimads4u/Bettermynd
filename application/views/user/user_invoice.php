                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align: right"><?php echo CURRENCY_SYMBOL . number_format($invoice_data['total_amount_after_discount'],2); ?></td>
                                </tr>
...
<!--                        <button class="btn btn-default" onclick="window.print();"><i class="fa fa-print"></i> Print</button>-->
 <a href="<?php echo USER_URL . 'download_invoice/' . $transaction_id; ?>" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> Download as PDF</a>
  <a href="<?php echo USER_URL . 'invoices';?>" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-arrow-left"></i> Back To List</a>
