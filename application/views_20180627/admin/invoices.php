          ...
          <tr>
            <th>#</th>
             <th>Transaction Number</th>
                        ...
                        <th>Sub Total (<?php echo CURRENCY_SYMBOL;?>)</th>
                        <!--<th>Description</th>-->
                        <th>Package</th>
...
<?php
                    if (isset($invoices) && count($invoices) > 0) {
                        ...
                        foreach ($invoices as $value) {
                            ...
                            . "<td>" . CURRENCY_SYMBOL.number_format($value->sub_total,2) . "</td>"
//                            . "<td>" . $value->transaction_description . "</td>"
                            ...
                            . "<td><a href='".ADMIN_URL."export_invoice/".$value->transaction_number."' class='label label-success'>View</a></td>"
                            . "</tr>";
                        }
                    }
                    ?>
