...
<h2 style="font-size:34px; text-align:center; font-weight:bold; color:#525252; padding:20px 0">Change Password</h2>
...
<p style="padding:10px 0; font-size:14px;margin:0">Your password changed successfully.</p>
    <p>You are requested to use new password for next login.</p><br />
