<div class="col-md-12">
    <?php
    $attributes = array('id' => 'thirtpartysignupform', 'class' => 'regration-form form-horizontal cutom-reg', "enctype" => "multipart/form-data");

    echo form_open(SITE_URL . "create_third_party_user", $attributes);
    ?>
        ...
        <div class="col-md-6 ">
            <div class="right-register">
                <div class="form-group">
                    <h3>Third-Party Counselor Registration</h3>
                </div>
                <div class="form-group">
                    <div id="infoMessage">
                        <?php
                ...
                <div class="form-group">
                    <label for="exampleInputState">Select State <span class="mandatory">*</span></label>
                    <?php
                    $options = $state;
                    $selected = isset($postdata) && !empty($postdata['state']) ? $postdata['state'] : '';
                ...
                <div class="form-group">
                    <div class="checkbox">
                        ...
                        <span class="paddtop10"><a data-toggle="modal" data-target="#myModal" class="to_register" href="javascript:void(0);"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" title="Third Party Terms & Conditions"></i> </a></span>
                    </div>
                </div>
