            ...
            <div class="x_content">
                ...
                <?php if (isset($upcoming_appointment) && !empty($upcoming_appointment) && count($upcoming_appointment) > 0) { ?>
                    ...
                    <div class="text-right">
                        <a href="<?php echo PROVIDER_URL; ?>upcoming_appoinment" class="btn btn-primary">More</a>
                    </div>
                <?php } ?>
            </div>
        </div>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <?php if (isset($past_appointment) && !empty($past_appointment) && count($past_appointment) > 0) { ?>
                    <div class="clearfix"></div>
                    <div class="text-right">
                        <a href="<?php echo PROVIDER_URL; ?>past_appoinment" class="btn btn-primary">More</a>
                    </div>
                <?php } ?>
            </div>
        </div>
...
<div id="updateModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo PROVIDER_URL; ?>updateavailabality" method="post">
                <div id="target_body">
