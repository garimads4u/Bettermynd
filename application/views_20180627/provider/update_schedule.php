...
<div class="modal-footer">
    ...
    if (!isset($patient_info)) {
        ...
        if ($is_start_meeting == 'YES') {
            ...
            <a href="<?php echo base_url('provider/joinappointment/' . base64_encode($app_id)); ?>" target="_blank" class="btn btn-success" id="btnfinal"><i class="fa fa-play"></i> Join Meeting</a>
