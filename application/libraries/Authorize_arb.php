...

{
    ...
    private $api_login_id = AUTHORIZE_LOGIN_ID;			// API Login ID

    private $api_transaction_key = AUTHORIZE_TRANSACTION_KEY;	// API Transation Key

    private $arb_api_url = AUTHORIZE_API_RECURRING_URL;			// Where we postin' to?
