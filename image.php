...
/*if($site_def=="localhost" )
{
define('DOCUMENT_ROOT',$_SERVER['DOCUMENT_ROOT']."/ppm/trunk/uploads/");
}
elseif($site_def=="brandize.com"){
	define("DOCUMENT_ROOT",$_SERVER['DOCUMENT_ROOT']."member/assets/upload/");
}
else
{
define('DOCUMENT_ROOT',$_SERVER['DOCUMENT_ROOT']."member/assets/upload/");
...
define('DOCUMENT_ROOT',urldecode($doc_root));
